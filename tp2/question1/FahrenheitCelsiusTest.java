...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        assertEquals("   39 °F -> 3.8 °C ?", 3.8, question1.FahrenheitCelsius.fahrenheitEnCelsius(39), 0.1);
        assertEquals("   27 °F -> -2.7 °C ?", -2.7, question1.FahrenheitCelsius.fahrenheitEnCelsius(27), 0.1);
        assertEquals("   68 °F -> 20.0 °C ?", 20.0, question1.FahrenheitCelsius.fahrenheitEnCelsius(68), 0.1);
        assertTrue( "  0 °F -> 20 °F " , question1.FahrenheitCelsius.fahrenheitEnCelsius(0) <
        question1.FahrenheitCelsius.fahrenheitEnCelsius(20));
    }
